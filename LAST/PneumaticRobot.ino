...
int s1[3] = {22, 23, 24};
int p1[3] = {8, 10, 12};
int speed_1[3] = {255, 255, 200};

int s2[3] = {26, 29, 28};
int p2[3] = {6, 4, A15};
int speed_2[3] = {200, 255, 255};

int s3[3] = {30, 31, 32};
int p3[3] = {A14, A8, A6};

int speed_3[3] = {255, 255, 255};

int s4[3] = {38, 39, 7};
int p4[3] = {A4, A2, A0};

int speed_4[12] = {255, 220, 255};
...
// int speedarray[12] = {speed_1[0], speed_1[1], speed_1[2], speed_2[0], speed_2[1], spd_2[2], speed_3[0], speed_3[1], speed_3[2]};
