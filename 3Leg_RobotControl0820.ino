...
int s1[3] = {24, 26, 25};
int p1[3] = {A0, A4, A2};
int speed_1[3] = {230, 200, 200};

int s2[3] = {28, 29, 30};
int p2[3] = {A6, A8, A10};
int speed_2[3] = {200, 200, 200};
...
int S_pin[12] = {s1[0], s1[1], s1[2], s2[0], s2[1], s2[2], s3[0], s3[1], s3[2]};
int P_pin[12] = {p1[0], p1[1], p1[2], p2[0], p2[1], p2[2], p3[0], p3[1], p3[2]};
int speedarray[12] = {speed_1[0], speed_1[1], speed_1[2], speed_2[0], speed_2[1], speed_2[2], speed_3[0], speed_3[1], speed_3[2]};
